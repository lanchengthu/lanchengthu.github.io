...
He currently serves as the Secretary of the IETF GROW Working Group. His research has been published in venues including ISOC NDSS, USENIX Security, and IEEE INFOCOM. He is also an author of multiple IETF WG documents. He has served as a TPC member for USENIX Security, ACM CCS, and APNIC conference. 
...
- **Jul 2024 - Now:** *Assistant Researcher* in Zhongguancun Laboratory
...
- Siyuan Teng, **Lancheng Qin (corresponding author)**, Li Chen, Dan Li, Ruifeng Li, Jianping Wu. Accurate and Stable AS Relationship Inference via Trusted Seeds and Semi-Supervised Learning. In [<span style="color:blue;">IEEE INFOCOM 2026</span>](https://infocom2026.ieee-infocom.org/accepted-paper-list-main-conference).
